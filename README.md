...
The demo shows the native Android workspace, conflict synchronization, Keep Mine conflict resolution, and the native SwiftUI iOS client.

[![Watch SyncBoard Demo](docs/screenshots/android/01-workspace.png)](docs/demo/syncboard-demo.mp4)

[Watch the full SyncBoard demo](docs/demo/syncboard-demo.mp4)
